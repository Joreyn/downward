...
# cpdbs
CPDBS_NUMBER_OF_PATTERNS = Attribute(
    "cpdbs_number_of_patterns", absolute=False, min_wins=True, function=geometric_mean
)
CPDBS_TOTAL_PDB_SIZE = Attribute(
    "cpdbs_total_pdb_size", absolute=False, min_wins=True, function=geometric_mean
)
CPDBS_AVERAGE_PDB_SIZE = Attribute(
    "cpdbs_average_pdb_size", absolute=False, min_wins=True, function=geometric_mean
)
CPDBS_COMPUTATION_TIME = Attribute(
    "cpdbs_computation_time", absolute=False, min_wins=True, function=geometric_mean
)

# single pdb
PDB_NUMBER_OF_VARIABLES = Attribute(
    "pdb_number_of_variables", absolute=False, min_wins=True, function=geometric_mean
)
PDB_SIZE = Attribute(
    "pdb_size", absolute=False, min_wins=True, function=geometric_mean
)
PDB_COMPUTATION_TIME = Attribute(
    "pdb_computation_time", absolute=False, min_wins=True, function=geometric_mean
)
